...
<head>
    ...
    <title>Reporte Rescate - Bomberos Voluntarios</title>
</head>
...
<body>
    ...
    <main class="text-center">
        ...
        <div class="card-body">
            ...
            <h5 class="">Reporte de Rescate</h5>
            ...
            <a href="formatosWord/rescate.docx" class="btn btn-primary" download="<?php echo "ID-" . $idFiltrado . "-"; ?>reporteRescate">
