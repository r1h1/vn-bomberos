...
<head>
    ...
    <title>Reporte Incendio - Bomberos Voluntarios</title>
</head>
...
<body>
    ...
    <main class="text-center">
        ...
        <div class="card-body">
            ...
            <h5 class="">Reporte de Incendios</h5>
            ...
            <a href="formatosWord/incendio.docx" class="btn btn-primary" download="<?php echo "ID-" . $idFiltrado . "-"; ?>reporteIncendio">
