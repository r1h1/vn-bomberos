...
<head>
    ...
    <title>Servicios Varios - Bomberos Voluntarios</title>
</head>
...
<body>
        ...
        <div class="container-sm mx-auto">
            <div class="row">
                <div class="col-md-12 mb-3">
                    <h5 class="fw-bold">Servicios Varios</h5>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card bg-nav text-dark h-auto stretch-card">
                        ...
                        <div class="card-body">
                            <form action="../../business/varios/insertarDatos.php" method="POST" class="row mt-2">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="" method="GET">
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="varios.php" class="btn btn-primary mt-2 ms-2" type="button">Ver Todo</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                if (isset($_GET['btnBuscar'])) {
                                                    ...
                                                    $query = "SELECT * FROM llamado_servicios_varios WHERE controlCorrelativo LIKE CONCAT('%', '$dato' , '%')
                                                ...
                                                ?>
                                                    ...
                                                    ?>
                                                        <td class="text-center">
                                                            <a href="../../business/varios/borrarDatos.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-danger">
    ...
    <script src="../../js/components/varios.js"></script>
    <script>
