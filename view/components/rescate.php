...
<head>
    ...
    <title>Rescate - Bomberos Voluntarios</title>
</head>
...
<body>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card bg-nav text-dark h-auto stretch-card">
                        ...
                        <div class="card-body">
                            <form action="../../business/rescate/insertarDatos.php" method="POST" class="row mt-2">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="" method="GET">
                                        <div class="input-group mb-3">
                                            ...
                                            <a href="rescate.php" class="btn btn-primary mt-2 ms-2" type="button">Ver Todo</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                if (isset($_GET['btnBuscar'])) {
                                                    ...
                                                    $query = "SELECT * FROM llamado_rescate WHERE controlCorrelativo LIKE CONCAT('%', '$dato' , '%')
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="../../business/reportes/reporteRescate.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-danger"><i class="fa-solid fa-file-pdf"></i></a>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="edicion/rescate.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-success">
                                                    ...
                                                    ?>
                                                        <td class="text-center">
                                                            <a href="../../business/rescate/borrarDatos.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-danger">
    ...
    <script src="../../js/components/rescate.js"></script>
    <script>
