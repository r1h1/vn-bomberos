...
<head>
    ...
    <title>Edicion Llamado Ambulancia - Bomberos Voluntarios</title>
</head>
        ...
        <div class="container-sm mx-auto">
            <div class="row">
                <div class="col-md-12 mb-3">
                    <h5 class="fw-bold">Edición de Llamadas - Ambulancia</h5>
                </div>
            </div>
                ...
                <div class="col-md-12 mb-3">
                    <div class="card bg-nav text-dark h-auto stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            $sql = "CALL consultarLlamadoAmbulanciaPorID('$idEdicion')";
                            ...
                            while ($mostrar = mysqli_fetch_array($result)) {
                                ...
                                $fkTelefonista = $mostrar[25];
                            }

                            ?>

                            <form action="../../../business/ambulancia/editarDatos.php" method="POST" class="row mt-2">
                                ...
                                <div class="col-md-12 col-lg-6 mt-4">
                                    ...
                                    $sql = "SELECT llamada.fkTelefonista,personal.nombreCompleto FROM `llamado_ambulancia` llamada
                                ...
                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Cantidad de Pacientes Atendidos *</label>
                                    <input type="number" class="form-control" required name="cantidadPacientesAtendidos"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Nombre(s) Paciente(s) *</label>
                                    <input type="text" class="form-control" required name="nombrePaciente"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Edad(es) Paciente(s) *</label>
                                    <input type="text" class="form-control" required name="edadPaciente"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Nombre Acompañante *</label>
                                    <input type="text" class="form-control" name="nombreAcompanante"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Trasladado Hacia *</label>
                                    <input type="text" class="form-control" required name="trasladoHacia"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Cantidad de Fallecidos *</label>
                                    <input type="number" class="form-control" required name="cantidadFallecidos"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Nombre(s) Fallecido(s) *</label>
                                    <input type="text" class="form-control" name="nombreFallecidos"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Tipo de Servicio *</label>
                                    <input type="text" class="form-control" name="tipoServicio"/>
                                </div>
