...
<head>
    ...
    <title>Edicion Llamado Rescate - Bomberos Voluntarios</title>
</head>
        ...
        <div class="container-sm mx-auto">
            <div class="row">
                <div class="col-md-12 mb-3">
                    <h5 class="fw-bold">Edición de Llamadas - Rescate</h5>
                </div>
            </div>
                ...
                <div class="col-md-12 mb-3">
                    <div class="card bg-nav text-dark h-auto stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            $sql = "SELECT * FROM `llamado_rescate` WHERE idLlamado = '$idEdicion';";
                            ...
                            <form action="../../../business/rescate/editarDatos.php" method="POST" class="row mt-2">
                                ...
                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Forma de Aviso *</label>
                                    <input type="text" class="form-control" name="formaDeAvisoPorTelefono"/>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Nombre(s) Rescatado(s) *</label>
                                    <input type="text" class="form-control" required name="nombreRescatados"/>
                                </div>

                                <div class="col-md-12 col-lg-6 mt-4">
                                    <label for="" class="form-label">Edad(es) Rescatado(s) *</label>
                                    <input type="text" class="form-control" required name="edadRescatados"/>
                                </div>
