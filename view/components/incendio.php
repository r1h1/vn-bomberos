                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="../../business/reportes/reporteIncendio.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-danger">
                                                        <i class="fa-solid fa-file-pdf"></i></a>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="edicion/incendio.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-success">
                                                    ...
                                                    ?>
                                                        <td class="text-center">
                                                            <a href="../../business/incendio/borrarDatos.php?search=<?php echo $mostrar['idLlamado']; ?>" class="btn btn-danger">
