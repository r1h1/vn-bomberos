...
<head>
  ...
  <title>Unidades - Bomberos Voluntarios</title>
</head>
...
<body>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          <div class="card bg-nav text-dark h-auto stretch-card">
            ...
            <div class="card-body">
              <form action="../../business/unidades/insertarDatos.php" method="POST" class="row mt-2">
                <div class="col-md-12 col-lg-6 mt-3">
                  <label for="" class="form-label">Código de la Unidad *</label>
                  <input type="text" class="form-control" required name="codigoUnidad" />
                </div>

                <div class="col-md-12 col-lg-6 mt-3">
                  <label for="" class="form-label">Nombre de la Unidad *</label>
                  <input type="text" class="form-control" required name="nombreUnidad" />
                </div>

                <div class="col-md-12 col-lg-6 mt-3">
                  <label for="" class="form-label">Placas de la Unidad *</label>
                  <input type="text" class="form-control" required name="placasUnidad" />
                </div>

                <div class="col-md-12 col-lg-6 mt-3">
                  <label for="" class="form-label">Marca de la Unidad *</label>
                  <input type="text" class="form-control" required name="marcaUnidad" />
                </div>

                <div class="col-md-12 col-lg-6 mt-3">
                  <label for="" class="form-label">Modelo de la Unidad *</label>
                  <input type="text" class="form-control" required name="modeloUnidad" />
                </div>

                <div class="col-md-12 col-lg-6 mt-3">
                  <label for="" class="form-label">Tipo de Unidad *</label>
                  <input type="text" class="form-control" required name="tipoUnidad" />
                </div>
                ...
                <div class="col-md-12 col-lg-12">
                  ...
                  <form action="" method="GET">
                    <div class="input-group mb-3">
                      ...
                      <a href="unidades.php" class="btn btn-primary mt-2 ms-2" type="button">Ver Todo</a>
                    ...
                    <tbody>
                      <tr>
                        ...
                        if (isset($_GET['btnBuscar'])) {
                          ...
                          $query = "CALL consultarUnidadesPorWhereLike('$dato');";
                        } else {
                        ...
                        ?>
                          <td hidden><?php echo $mostrar['idUnidad']; ?></td>
                          <td><?php echo $mostrar['codigoUnidad']; ?></td>
                          <td><?php echo $mostrar['nombreUnidad']; ?></td>
                          <td><?php echo $mostrar['placasUnidad']; ?></td>
                          <td><?php echo $mostrar['marcaUnidad']; ?></td>
                          <td><?php echo $mostrar['modeloUnidad']; ?></td>
                          <td><?php echo $mostrar['tipoUnidad']; ?></td>
                          <td>
                            <a href="edicion/unidades.php?search=<?php echo $mostrar['idUnidad']; ?>" class="btn btn-success"><i class="fa-solid fa-pen"></i></a>
                          </td>
                          <td>
                            <a href="../../business/unidades/borrarDatos.php?search=<?php echo $mostrar['idUnidad']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                          </td>
                      </tr>
                    <?php
                        }
  ...
  <script src="../../js/components/unidades.js"></script>
</body>
